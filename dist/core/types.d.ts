...
export declare const DEFAULT_PROTOCOL_VERSION = "1.0.0";
...
export interface SkillDefinition {
    ...
    executeWithContext?: (params: Record<string, unknown>, context: SkillExecutionContext) => Promise<Record<string, unknown>>;
